...
class StoryControllerIntegrationTest extends IntegrationTest {
    ...
    def "Test if createStory() creates a story and saves it to an existing feature of an existing epic"() {
        ...
        Story story = new Story(title: "New story", functionality: "Unknown", priority: "Unknown", assignee: "Unknown")
        ...
        expectedStory.getAssignee() == story.getAssignee()
    ...
    def "Test  updateStory() if the story will be updated when epic & feature are present"() {
        ...
        Story updatedStory = new Story(title: "New story", functionality: "Updated", priority: "Updated2", assignee: "Unknown")
        ...
        resultStory.get(0).getAssignee() == updatedStory.getAssignee()
    ...
    def "Test if patchStory() will patch a field of an existing story with epic & feature present in the database"() {
        ...
        expectedStory.getAssignee() == patchedStory.getAssignee()

    }

    def "Test whether will patchStory() throw an exception when epic & feature are not present in database"() {
        when:
        storyController.patchStory(UUID.randomUUID(), "Random feature", "Random title", [name: "Random story", priority: "Random priority", assignee: "Unknown"])
